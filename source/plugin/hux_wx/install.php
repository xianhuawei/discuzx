...
CREATE TABLE IF NOT EXISTS `pre_hux_wx` (
...
CREATE TABLE IF NOT EXISTS `pre_hux_wx_action` (
  `openid` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_hux_wx_config` (
...
CREATE TABLE IF NOT EXISTS `pre_hux_wx_userjp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0',
