...
if($types == 1){
	...
	if(!submitcheck('reportsubmit')) {
		...
		showmessage(lang('plugin/hsk_vcenter', 'manage_sc'), PDIR.'&mod=manage&action=index'.$_types.$_fid.$_search);
	}
