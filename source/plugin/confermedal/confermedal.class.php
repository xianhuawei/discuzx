...
class plugin_confermedal
{
}

class plugin_confermedal_forum extends plugin_confermedal
{
    public function index_bottom ()
    {
        global $_G;
        $enable = isset( $_G['cache']['plugin']['confermedal']['confermedal_enable'] ) ? $_G['cache']['plugin']['confermedal']['confermedal_enable'] : 0;
        if ( ! $enable || ! $_G['uid'] )
            return;
        $notice_enable = isset( $_G['cache']['plugin']['confermedal']['confermedal_notice_enable'] ) ? $_G['cache']['plugin']['confermedal']['confermedal_notice_enable'] : 0;
        $notice_title = isset( $_G['cache']['plugin']['confermedal']['confermedal_notice_title'] ) ? $_G['cache']['plugin']['confermedal']['confermedal_notice_title'] : '';
        $notice_content = isset( $_G['cache']['plugin']['confermedal']['confermedal_notice_content'] ) ? $_G['cache']['plugin']['confermedal']['confermedal_notice_content'] : '';
