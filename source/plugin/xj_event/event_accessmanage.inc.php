...
$query = DB::query("SELECT * FROM ".DB::table('plugin_xj_eventapply')." A,".DB::table('common_member')." B WHERE A.uid = B.uid and A.tid = '$tid' and A.verify=1 ORDER BY A.verify,A.dateline LIMIT $start_limit,$perpage");
$accesslist = array();
