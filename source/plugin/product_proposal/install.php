<?php
/**
 *	[产品建议(product_proposal.install)] (C)2015-2099 Powered by xianhuawei.
 *	Version: 1.0
...
CREATE TABLE `pre_feedback_proposal` (                                                        
	`tid` bigint(20) NOT NULL COMMENT '主题id',                                              
	`feedback_status` smallint(6) NOT NULL COMMENT '建议状态',                             
	`contact` varchar(15) NOT NULL DEFAULT '' COMMENT '联系方式',                          
	`support` smallint(6) NOT NULL DEFAULT '0' COMMENT '赞同人数',                         
	`funtion` varchar(15) NOT NULL DEFAULT '' COMMENT '功能点',                             
	`description` varchar(1000) NOT NULL DEFAULT '' COMMENT '功能描述',                    
	`background` varchar(1000) NOT NULL DEFAULT '' COMMENT '需求背景',                     
	`snapshot` tinyint(1) NOT NULL DEFAULT '0' COMMENT '原生demo,0无附件 1普通附件',  
	PRIMARY KEY (`tid`),                                                                       
	KEY `IDX_TID_STATUS` (`tid`,`feedback_status`)                                             
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
