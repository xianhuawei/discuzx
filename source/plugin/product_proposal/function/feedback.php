...
{
    $first_category = C::t("#product_proposal#common_category")->fetch_first_list();
...
{
    $leaf_category = C::t("#product_proposal#common_category")->fetch_leaf_list();
...
function getVersion()
{
    $data = C::t("#product_proposal#common_basedata")->fetch_by_type('VERSION_DATA');
    return $data;
}
...
function  getMachine()
{
    $data = C::t("#product_proposal#common_basedata")->fetch_by_type('MODEL_DATA');
    return $data;
}
...
{
    $data = C::t("#product_proposal#common_basedata")->fetch_by_type('PROBABILITY_DATA');
    return $data;
}
...
{
    $data = C::t("#product_proposal#common_category")->fetch_leaf();
    return $data;
}
...
{
    return C::t('#product_proposal#feedback_proposal')->insert($data);
}
...
{
	return C::t('#product_proposal#feedback_proposal')->update_by_tid($tid, $data);
}

function checktypeid($typeid)
{
    $data = C::t("#product_proposal#common_category")->fetch_by_id($typeid);
...
function getDataBycode($type,$code){
    return C::t("#product_proposal#common_basedata")->fetch_name_by_type_code($type,$code);
}
