...
class plugin_bddrivevideo {
	function global_footer() {
		global $_G;
		
		$geneecache = $_G ['cache'] ['plugin'] ['bddrivevideo'];
		$geneelang = lang ( 'plugin/bddrivevideo' );
		...
		function bddrivevideoSearch(position,msg){
			...
			var url2="plugin.php?id=bddrivevideo:getbaiduurlname&"+param;
