 ...
 *
 *      $Id: table_mpage_weibo.php 31511 2013-04-30 23:50:05Z mpage $
 */
...
class table_mpage_weibo extends discuz_table {

	public function __construct() {
		$this->_table = 'mpage_weibo';
		$this->_pk    = 'uid';
		$this->_pre_cache_key = 'mpage_weibo_';
		parent::__construct();
	}
