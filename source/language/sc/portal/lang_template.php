...
$lang = array (
  ...
  'article_page_save_after' => '保存并添加新分页',
  ...
  'data_repeat_recommend' => '提醒： 此信息已经在该模块的推送库里了。',
  'day' => '天',
  ...
  'portalcp_block_message1' => '提醒： 你选择了隐藏输出，模块不会输出任何内容；但是您可以在页面模板中调用模块的数据。',
  ...
  'todo_updateblock_message' => '是否即时更新模块数据',
  'update_mod' => '更新模块',
  ...
  'find' => '查找',
  'moderate' => '审核',
  'no_moderate_push_data' => '没有需要审核的推送数据',
  'push_page' => '推送页面',
  'push_people' => '推送者',
  'unused' => '未使用',
  ...
  'topic_submit' => '专题标题',
  'topic_tplname_comment' => '请将模板文件上传到 template/default/portal目录下，文件名必须为portal_topic_*.htm，*为自定义文件名<br />如果要重新选择模板，请确保新模板与原模板中可拖拽区域具有相同的ID，否则将会丢失分部或全部原DIY数据',
  'tplname' => '模板名',
