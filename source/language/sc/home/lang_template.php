...
/*vot*/  'interactive_help_message' => '<li>来访用户：指的是每天访问本站的唯一用户数。一个用户访问多次，也只算一次</li>
  ...
  'edit' => '编辑',
  'explain_album' => '下面列出的是您自行创建相册列表。<br />
						您在日志里面上传的图片附件，全部存放在 <a href="home.php?mod=space&uid=$space[uid]&do=album&id=-1" style="font-weight: 700;">系统默认相册</a> 里面',
