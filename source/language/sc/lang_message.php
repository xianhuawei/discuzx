...
$lang = array (
  ...
  'post_thread_closed' => '抱歉，本主题已关闭，不再接受新回复',
  ...
  'post_newthread_mod_succeed' => '新主题需要审核，您的帖子通过审核后才能显示',
  'post_newthread_succeed' => '非常感谢，您的主题已发布，现在将转入主题页，请稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入主题列表 ]</a>',
...
/*!*/  'search_closed' => '搜索功能已关闭',
  ...
  'no_privilege_avatar' => '抱歉，您需要设置自己的头像后才能进行本操作，<a href="home.php?mod=spacecp&ac=avatar" target="_blank">点击这里设置</a>',
  ...
  'username_nonexistence' => '抱歉，指定用户不存在',
  ...
  'group_invite_not_author' => '抱歉，您不是本主题的作者无法发出邀请',
  ...
  'data_in_mod_library' => '该数据已在模块推荐库里',
  ...
  'portalcp_block_has_no_block' => '请选择要加入更新队列的模块',
  ...
  'memcp_credits_transfer_msg_user_incorrect' => '抱歉，您尚未输入转账接收人或者接收人不存在',
  ...
  'message_bad_touid' => '抱歉，用户不存在，请检查用户uid是否正确',
  'message_bad_touser' => '抱歉，用户不存在，请检查用户名是否正确',
  ...
  'admin_expiration_invalid' => '抱歉，有效期无效',
  ...
  'register_email_verify' => '感谢您的注册 {bbname}，<br />系统给您发送了一封激活邮件，快去登录邮箱激活账号吧',
  ...
  'register_succeed' => '感谢您的注册 {bbname}，现在将以 {usergroup} 身份登录站点',
  ...
  'admin_cpanel_noaccess_ip' => '抱歉，只有特定 IP 范围才能访问',
