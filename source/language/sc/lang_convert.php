...
$lang = array(
	...
	'config_extcredits'	=> '积分配置',//'Extended points configuration',
...
//convert/include/do_finish.inc.php
	...
	'start_time'		=> '本次升级开始时间',//'Upgrade start time',
	'end_time'		=> '本次升级结束时间',//'Upgrade end of time',
...
//convert/include/do_select.inc.php
	...
	'process_number'	=> '个转换程序,下面开始转换',//'Conversion process start the following conversion',
