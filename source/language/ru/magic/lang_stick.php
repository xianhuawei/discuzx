...
(
	...
	'stick_info_noperm'		=> 'В данном разделее использование этого артефакта запрещено',

	'stick_notification'		=> '{actor} использовал артефакт &quot;{magicname}&quot; для прикрепления темы &quot;<a href="forum.php?mod=viewthread&tid={tid}">{subject}</a>&quot;',
);
