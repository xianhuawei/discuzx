...
(
	'jack_name'		=> 'Топинатор',
	'jack_desc'		=> 'Поднятие темы в топ на указанное время. Артефакт может использоваться повторно.',
	...
	'jack_info'			=> '<p class="mtn xw0 mbn">Поднятие указанной темы в топ на <span class="xi1 xw1 xs2">{expiration}</span> час.</p><p class="mtn xw0 mbn">Артефакт можно использовать <span class="xi1 xw1 xs2">{magicnum}</span> раз.</p>',
	...
	'jack_info_noperm'	=> 'В данном разделе запрещено использование этого артефакта!',
