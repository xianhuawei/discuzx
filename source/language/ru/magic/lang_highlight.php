...
(
	...
	'highlight_forum'		=> 'Разрешено использовать в форумах',
	'highlight_info_tid'		=> 'Время действия подсветки: {expiration}',
	'highlight_info_blogid'		=> 'Вы можете подсветить указанным цветом заголовок блога или темы на форуме',
	'highlight_color'		=> 'Цвет',
	'highlight_info_nonexistence_tid'	=> 'Укажите тему для подсветки',
	'highlight_info_nonexistence_blogid'	=> 'Укажите блог для подсветки',
	'highlight_succeed_tid'		=> 'Тема успешно подсвечена', 
	'highlight_succeed_blogid'	=> 'Блог успешно подсвечен',
