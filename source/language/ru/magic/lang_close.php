...
$lang = array
(
	'close_name'			=> 'Молчание ягнят',
	'close_desc'			=> 'Запрещает отвечать в теме',
	'close_expiration'		=> 'Период запрета ответов',
	'close_expiration_comment'	=> 'Укажите период времени, в течение которого ответы в теме будут запрещены. По умолчанию 24 часа.',
	'close_forum'			=> 'Разрешено использовать в форумах',
