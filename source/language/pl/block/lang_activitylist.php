 ...
 *
 *      $Id: lang_activitylist.php by Valery Votintsev at 
...
$lang = array
(
	'activitylist_fids'			=> 'Fora',//'所在版块',
	'activitylist_fids_comment'		=> 'Wybierz fora, które zostaną wyświetlone. Przytrzymaj CTRL, aby wybrać kilka forów.',//'设置允许参与新帖调用的版块，可以按住 CTRL 多选，全选或全不选均为不做限制',
	'activitylist_uids'			=> 'Id-y użytkowników',//'发起者UID',
	'activitylist_uids_comment'		=> 'Wybierz użytkownika, który zostanie wyświetlony. Użyj ",", aby oddzielić identyfikatory.',//'设置活动发起者UID，多个UID请用半角逗号“,”隔开。',
	...
	'activitylist_items'			=> 'Wiersze',//'显示数据条数',
	'activitylist_items_comment'		=> 'Wybierz liczbę wierszy, którą chcesz wyświetlić. To pole musi zawierać dane liczbowe i przekraczać wartość 0',//'设置一次显示的主题条目数，请设置为大于 0 的整数',
	'activitylist_titlelength'		=> 'Długość tytułu',//'标题最大字节数',
	'activitylist_titlelength_comment'	=> 'Wybierz maks. długość tytułu. Tytuł zostanie automatycznie skrócony, kiedy przekroczy dopuszczalny limit znaków. 0 wyłącza opcję.',//'设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
	'activitylist_fnamelength'		=> 'Długość tytułu forum',//'标题最大字节数包含版块名称',
	...
	'activitylist_tids'			=> 'Tematów',//'指定主题',
	...
	'activitylist_digest_1'			=> 'Wykopany I',//'精华 I',
	'activitylist_digest_2'			=> 'Wykopany II',//'精华 II',
	'activitylist_digest_3'			=> 'Wykopany III',//'精华 III',
	...
	'activitylist_stick_1'			=> 'Ważny I',//'置顶 I',
	'activitylist_stick_2'			=> 'Ważny II',//'置顶 II',
	'activitylist_stick_3'			=> 'Ważny III',//'置顶 III',
	...
	'activitylist_special_1'		=> 'Ankiety',//'投票主题',
	'activitylist_special_2'		=> 'Produkty/Sprzedaże',//'商品主题',
	'activitylist_special_3'		=> 'Nagrody',//'悬赏主题',
	'activitylist_special_4'		=> 'Wydarzenia',//'活动主题',
	'activitylist_special_5'		=> 'Debaty',//'辩论主题',
	'activitylist_special_0'		=> 'Zwykły temat',//'普通主题',
	'activitylist_special_reward'		=> 'Filtr nagród',//'悬赏主题过滤',
	'activitylist_special_reward_comment'	=> 'Wybierz typ nagrody',//'设置特定类型的悬赏主题',
	'activitylist_special_reward_0'		=> 'Wszystkie',//'全部',
	'activitylist_special_reward_1'		=> 'Ukończone',//'已解决',
	'activitylist_special_reward_2'		=> 'Aktywne',//'未解决',
	...
	'activitylist_orderby'			=> 'Sortuj wg.',//'主题排序方式',
	'activitylist_orderby_comment'		=> 'Set the thread ordering',//'设置以哪一字段或方式对主题进行排序',
	'activitylist_orderby_lastpost'		=> 'Ostatni post',//'按最后回复时间倒序排序',
	...
	'activitylist_orderby_todayhots'	=> 'Gorące dziś',//'按当天累计售出数倒序排序',
	'activitylist_orderby_weekhots'		=> 'Gorące z ostatniego tygodnia',//'按本周累计售出数倒序排序',
	'activitylist_orderby_monthhots'	=> 'Gorące z ostatniego miesiąca',//'按当月累计售出数倒序排序',
	'activitylist_price_add'		=> ' Dodatkowe ',//' 附加 ',
	'activitylist_place'			=> 'Miejsce',//'活动地点',
	'activitylist_class'			=> 'Typ',//'活动类型',
	'activitylist_class_all'		=> 'Wszystko',//'所有类型',
	'activitylist_gender'			=> 'Płeć',//'性别要求',
	'activitylist_gender_0'			=> 'Dowolna',//'不限',
	'activitylist_gender_1'			=> 'Mężczyzna',//'男',
	'activitylist_gender_2'			=> 'Kobieta',//'女',
	'activitylist_orderby_weekstart'	=> 'Rozpoczęte w z ostatnim tygodniu',//'按一周内活动开始时间排序',
	'activitylist_orderby_monthstart'	=> 'Rozpoczęte w ostatnim miesiącu',//'按一月内活动开始时间排序',
	'activitylist_orderby_weekexp'		=> 'Wygasłe w ubiegłym tygodniu',//'按一周内报名截止时间排序',
	'activitylist_orderby_monthexp'		=> 'Wygasłe w ubiegłym miesiącu',//'按一月内报名截止时间排序',
	'activitylist_orderby_weekhot'		=> 'Gorące z ostatniego tygodnia',//'按一周内已参加人数排序',
	'activitylist_orderby_monthhot'		=> 'Gorące z ostatniego miesiąca',//'按一月内已参加人数排序',
