 ...
 *        Traduit par Andre13 Support http://discuz-fr.fr -27 d�c 2011
...
(
	...
	'config_notfound'	=> 'Fichier Configuration "config_global.php" est Inexistant ou ne peut pas acc&#233;der.', // 'Configuration file "config_global.php" does not exist or cannot access.'
	'template_notfound'	=> 'Fichier  Mod&#232;le "$tplfile" est Inexistant ou ne peut pas acc&#233;der.', // 'Template file "$tplfile" does not exist or cannot access.'
	'directory_notfound'	=> 'R&#233;pertoire "$dir" est Inexistant ou ne peut pas acc&#233;der.', // 'Directory "$dir" does not exist or cannot access.'
	'request_tainting'	=> 'Requ&#234;te incorrecte.', // 'Invalid requrest.'
	'db_help_link'		=> 'Besoin de Soutien?', // 'Need help?'
	'db_error_message'	=> 'Message Erreur', // 'Error Message'
	...
	'db_query_error'	=> 'Erreur Requ&#234;te', // 'Query error'
	'db_config_db_not_found'	=> 'Erreur Configuration de base de donn&#233;es, Svp. v&#233;rifier config_global.php', // 'Database configuration error, please check config_global.php'
	...
	'file_upload_error_-101'	=> 'Impossible de t&#233;l&#233;charger! Le fichier est Inexistant ou ill&#233;gale, Svp. revenir.', // 'Failed to upload! The file does not exist or illegal, please return.'
