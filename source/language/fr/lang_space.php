...
$lang = array(
	...
	'friend_group_1'	=> 'Savoir par le site', // Know by site
	'friend_group_2'	=> 'Savoir par les activit&#233;s', // Know by activities
	'friend_group_3'	=> 'Savoir par les Amis', // Know by friends
	...
	'friend_group'		=> 'Coutumes', // Custome
	'wall'			=> 'Message', // Message
	'pic_comment'		=> 'Image comment.', // Image comment
	'blog_comment'		=> 'Blog comment.', // Blog comment
	'clickblog'		=> 'Attitude(Blog)', // Attitude(Blog)
	'clickpic'		=> 'Attitude(Image)', // Attitude(Image)
	'clickthread'		=> 'Attitude(Article)', // Attitude(Article)
	'share_comment'		=> 'Commentaire(Partage)', // Comment(Share)
	'share_notice'		=> 'Partage', // Share
	'doing_comment'		=> 'Commentaire(Agissements)', // Comment(Doing)
	'friend_notice'		=> 'Ami', // Friend
	'poll_comment'		=> 'Commentaire(Sondage)', // Comment(Poll)
	'poll_invite'		=> 'Sondage Invitation', // Poll invitation
	'default_albumname'	=> 'Album par d&#233;faut', // Default album
	'credit'		=> 'Points', // Points
	'credit_unit'		=> ' ', // ' '
	'man'			=> 'Homme', // Male
	'woman'			=> 'Femme', // Female
	'gender_0'		=> 'Secret', // Secret
	'gender_1'		=> 'Homme', // Male
	'gender_2'		=> 'Femme', // Female
	'year'			=> '/', // '/'
	'month'			=> '/', // '/'
	'day'			=> '/', // '/'
	'unmarried'		=> 'C&#233;libataire', // Single
	'married'		=> 'Mari&#233;', // Married
	'hidden_username'	=> 'Anonyme', // Anonymous
	'gender'		=> 'Genre', // Gender
	'age'			=> ' ans', // ' years old'
	...
	'constellation_4'	=> 'Taureau', // Taurus
	'constellation_5'	=> 'G&#233;meaux', // Gemini
	'constellation_6'	=> 'Cancer', // Cancer
	'constellation_7'	=> 'Lion', // Leo
	'constellation_8'	=> 'Vierge', // Virgo
	'constellation_9'	=> 'Balance', // Libra
	'constellation_10'	=> 'Scorpion', // Scorpio
	...
	'zodiac_6'		=> 'Vers', // Snake
	'zodiac_7'		=> 'Cheval', // Horse
	'zodiac_8'		=> 'Ch&#232;vre', // Goat
	'zodiac_9'		=> 'Singe', // Monkey
	'zodiac_10'		=> 'Coq', // Rooster
	'zodiac_11'		=> 'Chien', // Dog
	'zodiac_12'		=> 'Porc', // Pig

	'credits'		=> 'Points', // Points
	'usergroup'		=> 'Groupe Utilisateur', // User Group
	'friends'		=> 'Amis', // Friends
	'blogs'			=> 'Blogs', // Blogs
	'threads'		=> 'Sujets', // Threads
	'albums'		=> 'Albums', // Albums
	'sharings'		=> 'Partages', // Shares
	'space_views'		=> 'Vous avez d&#233;j&#224; <strong class="xi1">{views}</strong> visiteur', // 'Already have <strong class="xi1">{views}</strong> visitor'
	'views'			=> 'Vues Espace', // Space Views
	'block1'		=> 'Personnaliser Module 1', //  Customize Moule 1
	'block2'		=> 'Personnaliser Module 2', //  Customize Moule 2
...
/*vot*/	'blockdata'		=> array(
	...
	'wall_more'		=> '<dl><dt><span class="y xw0"><a href="home.php?mod=space&uid={uid}&do=wall">&raquo; Voir tout</a></span><dt></dl>', // '<dl><dt><span class="y xw0"><a href="home.php?mod=space&uid={uid}&do=wall">&raquo; View all</a></span><dt></dl>'
	'wall_edit'		=> '<a href="home.php?mod=spacecp&ac=comment&op=edit&cid={cid}&handlekey=editcommenthk_{cid}" id="c_{cid}_edit" onclick="showWindow(this.id, this.href, \'get\', 0);">Editer</a> ', // '<a href="home.php?mod=spacecp&ac=comment&op=edit&cid={cid}&handlekey=editcommenthk_{cid}" id="c_{cid}_edit" onclick="showWindow(this.id, this.href, \'get\', 0);">Edit</a> '
	...
	'sb_blog'		=> '{who}\'s blogs', // '{who}\'s blogs'
	...
	'sb_profile'		=> '{who}\'s profil', // '{who}\'s profile'
	'sb_thread'		=> '{who}\'s posts', // '{who}\'s posts'
