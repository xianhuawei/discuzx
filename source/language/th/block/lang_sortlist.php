...
(
	...
	'sortlist_titlelength'	=> 'จำนวนไบท์สูงสุดของชื่อกระทู้',
	'sortlist_titlelength_comment'	=> 'กำหนดความยาวของชื่อกระทู้，หากกำหนดจำนวนไบต์เกินจะไม่ลดโดยอัตโนมัติ，0 คือจะลดโดยอัตโนมัติ',
	'sortlist_fnamelength'	=> 'จำนวนไบท์สูงสุดของชื่อบอร์ด',
	'sortlist_fnamelength_comment'	=> 'กำหนดความยาวของชื่อบอร์ด และความยาวของชื่อกระทู้จะถูกนับเข้าด้วยกัน',
	'sortlist_summarylength'	=> 'จำนวนไบท์สูงสุดของเนื้อหา',
	'sortlist_summarylength_comment'	=> 'กำหนดจำนวนไบท์สูงสุดของเนื้อหา，0 คือค่าเริ่มต้น สามารถกำหนดได้สูงสุดถึง 255',
	...
	'sortlist_keyword'	=> 'คำค้นของหัวข้อ',
	'sortlist_keyword_comment'	=> 'ตั้งค่าคำค้นของกระทู้ หมายเหตุ: ปล่อยว่างไว้หากไม่มีคำค้นใดๆ<br />สามารถใช้สัญลักษณ์ "*" แทนคำค้นหลัก<br />ค้นหาโดยคำค้นหลักเพิ่มเติม，สามารถใช้ช่องว่างระหว่างคำ หรือ "AND" ในการค้นหา เช่น win32 AND unix<br />และสามารถใช้ "|" หรือ "OR" เพื่อให้ตรงกับคำค้นหลักที่มากกว่าหนึ่งคำ， เช่น win32 OR unix',
