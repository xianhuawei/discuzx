...
$lang = array (
  ...
  'addons_provider_nonexistence' => '資源提供商不存在',
  'addons_provider_disabled' => '資源提供商不存在或已被關閉',
  ...
  'founder_perm_member_noexists' => '用戶不存在',
  ...
  'fields_edit_succeed' => '用戶資料欄目更新成功 ',
  ...
  'addons_provider_apiinvalid' => '資源提供商資源連接錯誤',
  ...
  'plugins_config_upgrade_confirm' => '你確定要把 {pluginname} {version} 插件升級到 {toversion} 嗎？',
  'plugins_config_upgrade_missed' => '此插件無需升級，請上傳新版本後再執行本操作',
  ...
  'plugins_delete_error' => '你不能卸載系統插件。',
  'plugins_delete_confirm' => '你確定要卸載 {pluginname} {toversion} 插件嗎？',
  ...
  'plugins_validator_nowupgrade' => '<h4 class="infotitle2">以下插件現在可以更新為新版本，點擊升級</h4>',
  'plugins_validator_newversion' => '<h4 class="infotitle2">以下插件存在新版本，點擊下載更新</h4>',
  'plugins_validator_error' => '<h4 class="infotitle3">以下插件不是原版插件無法提供更新檢查，點擊下載原版</h4>',
  ...
  'postsplit_do_succeed' => '恭喜你,帖子分表操作成功,請返回',
  'postsplit_resetpid_succeed' => 'Post ID 重置完成',

  'profilefield_not_found' => '欄目未找到',
  'fields_edit_invalid' => '項目名稱和長度不能為空',
  ...
  'specialuser_defaultuser_noreason_invalid' => '請輸入原因',
  ...
  'specialuser_defaultuser_nouser_invalid' => '該用戶不存在',
  'specialuser_hotuser_nouser_invalid' => '該用戶不存在',
  ...
  'styles_install_succeed' => '界面方案安裝完成',
  ...
  'cloudaddons_check_url_fopen_error' => '您的服務器無法訪問應用中心，這將會導致應用無法安裝。請聯繫您的服務商或者網站技術人員，確保您的服務器能夠正常訪問 addon.discuz.com',
);
