...
$lang = array (
  ...
  'block_edit_nopermission' => '抱歉，您沒有權限添加或編輯模塊',
  ...
  'post_thread_closed' => '抱歉，本主題已關閉，不再接受新回復',
  ...
  'post_flood_ctrl_posts_per_hour' => '抱歉，您所在的用戶組每小時限制發帖 {posts_per_hour} 個，請稍候再發表',
  ...
  'post_newthread_mod_succeed' => '新主題需要審核，您的帖子通過審核後才能顯示',
  'post_newthread_succeed' => '非常感謝，您的主題已發佈，現在將轉入主題頁，請稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 點擊這裡轉入主題列表 ]</a>',
  ...
  'no_privilege_avatar' => '抱歉，您需要設置自己的頭像後才能進行本操作，<a href="home.php?mod=spacecp&ac=avatar" target="_blank">點擊這裡設置</a>',
  ...
  'username_nonexistence' => '抱歉，指定用戶不存在',
  ...
  'group_invite_not_author' => '抱歉，您不是本主題的作者無法發出邀請',
  ...
  'seccode_player' => '<span style="padding:2px">{flashcode}<img border="0" style="vertical-align:middle" src="static/image/common/seccodeplayer.gif" /> <a  href="javascript:;" onclick="updateseccode(\'{idhash}\', 1)">播放驗證碼</a></span>',
  ...
  'article_delete_invalid_lastpage' => '抱歉，當前為最後一頁，不能被刪除',
  ...
  'data_in_mod_library' => '該數據已在模塊推薦庫裡',
  ...
  'portalcp_block_has_no_block' => '請選擇要加入更新隊列的模塊',
  ...
  'thread_delete_succeed' => '主題刪除成功 ',

  'member_nonexistence' => '抱歉，指定的用戶不存在或已被刪除',
  ...
  'memcp_credits_transfer_msg_user_incorrect' => '抱歉，您尚未輸入轉賬接收人或者接收人不存在',
  ...
  'message_bad_touid' => '抱歉，用戶不存在，請檢查用戶uid是否正確',
  'message_bad_touser' => '抱歉，用戶不存在，請檢查用戶名是否正確',
  ...
  'pm_ignore_error_nopm' => '抱歉，您指定的用戶不存在',
  'pm_kickmember_error_nopm' => '抱歉，您要踢除的用戶不存在',
  'pm_appendkmember_error_nopm' => '抱歉，您要添加的用戶不存在',
  ...
  'admin_expiration_invalid' => '抱歉，有效期無效',
  ...
  'register_email_verify' => '感謝您的註冊 {bbname}，<br />系統給您發送了一封激活郵件，快去登錄郵箱激活賬號吧',
  ...
  'register_manual_verify' => '感謝您的註冊，站點開啟了人工驗證註冊用戶，請等待審核，現在將轉入個人中心首頁',
  'register_manual_verify_location' => '<a href="home.php?mod=space&do=home">先去逛逛</a>',
  'register_succeed' => '感謝您的註冊 {bbname}，現在將以 {usergroup} 身份登錄站點',
