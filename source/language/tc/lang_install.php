...
$lang = array(
	...
	'install_dzfull' => '<br><label><input type="radio"'.(getgpc('install_ucenter') != 'no' ? ' checked="checked"' : '').' name="install_ucenter" value="yes" onclick="if(this.checked)$(\'form_items_2\').style.display=\'none\';" /> 全新安裝 Discuz! X (含 UCenter Server)</label>',
	'install_dzonly' => '<br><label><input type="radio"'.(getgpc('install_ucenter') == 'no' ? ' checked="checked"' : '').' name="install_ucenter" value="no" onclick="if(this.checked)$(\'form_items_2\').style.display=\'\';" /> 僅安裝 Discuz! X (手工指定已經安裝的 UCenter Server)</label>',
...
<p>用戶須知：本協議是您與康盛公司之間關於您非商業使用康盛公司提供的各種軟件產品及服務的法律協議。無論您是個人或組織、盈利與否、用途如何（包括以學習和研究為目的），均需仔細閱讀本協議，包括免除或者限制康盛責任的免責條款及對您的權利限制。請您審閱並接受或不接受本服務條款。如您不同意本服務條款及/或康盛隨時對其的修改，您應不使用或主動取消康盛公司提供的康盛產品。否則，您的任何對康盛產品中的相關服務的註冊、登陸、下載、查看等使用行為將被視為您對本服務條款全部的完全接受，包括接受康盛對服務條款隨時所做的任何修改。</p>

<p>本服務條款一旦發生變更, 康盛將在網頁上公佈修改內容。修改後的服務條款一旦在網頁上公佈即有效代替原來的服務條款。您可隨時登陸康盛官方論壇查閱最新版服務條款。如果您選擇接受本條款，即表示您同意接受協議各項條件的約束。如果您不同意本服務條款，則不能獲得使用本服務的權利。您若有違反本條款規定，康盛公司有權隨時中止或終止您對康盛產品的使用資格並保留追究相關法律責任的權利。</p>

<p>在理解、同意、並遵守本協議的全部條款後，方可開始使用康盛產品。您可能與康盛公司直接簽訂另一書面協議，以補充或者取代本協議的全部或者任何部分。</p>
...
<li>本協議是您與康盛公司之間關於您非商業使用康盛公司提供的各種軟件產品及服務的法律協議，若您需將康盛軟件或服務用戶商業用途，必須另行獲得康盛的書面許可，您在獲得商業授權之後，您可以將本軟件應用於商業用途，同時依據所購買的授權類型中確定的技術支持期限、技術支持方式和技術支持內容，自購買時刻起，在技術支持期限內擁有通過指定的方式獲得指定範圍內的技術支持服務。商業授權用戶享有反映和提出意見的權力，相關意見將被作為首要考慮，但沒有一定被採納的承諾或保證。</li>
</ol>
...
<li>康盛公司對康盛提供的軟件和服務之及時性、安全性、準確性不作擔保，由於不可抗力因素、康盛公司無法控制的因素（包括黑客攻擊、停斷電等）等造成軟件使用和服務中止或終止，而給您造成損失的，您同意放棄追究康盛公司責任的全部權利。</li>
<li>康盛公司特別提請您注意，康盛公司為了保障公司業務發展和調整的自主權，康盛公司擁有隨時經或未經事先通知而修改服務內容、中止或終止部分或全部軟件使用和服務的權利，修改會公佈於康盛公司網站相關頁面上，一經公佈視為通知。 康盛公司行使修改或中止、終止部分或全部軟件使用和服務的權利而造成損失的，康盛公司不需對您或任何第三方負責。
</li>
</ol>

<p>有關康盛產品最終用戶授權協議、商業授權與技術服務的詳細內容，均由 康盛公司獨家提供。康盛公司擁有在不事先通知的情況下，修改授權協議和服務價目表的權利，修改後的協議或價目表對自改變之日起的新授權用戶生效。</p>
...
<p>若您和康盛之間發生任何糾紛或爭議，首先應友好協商解決，協商不成的，您在此完全同意將糾紛或爭議提交康盛所在地北京市海澱區人民法院管轄。康盛公司擁有對以上各項條款內容的解釋權及修改權。</p>
	...
	'testdata' => '附加數據',
	'testdata_check_label' => '完整地區數據（四級）',
	'portalstatus' => '開啟門戶功能',
...
$msglang = array(
	'config_nonexistence' => '您的 config.inc.php 不存在, 無法繼續安裝, 請用 FTP 將該文件上傳後再試。',//'Your config.inc.php file does not exist. Can not continue the installation, please use the FTP to upload the file and try again.',
);
