...
$lang = array (
  ...
  'group_demise_notice' => '<h2>溫馨提示：</h2><p>{$_G[setting][navs][3][navname]}轉讓成功後，你依然是該群的群主，但不再是{$_G[setting][navs][3][navname]}創始人，所以可自由退出該{$_G[setting][navs][3][navname]}。</p><p>轉讓後無法直接恢復群，需被接收者主動操作才可以再次轉回，請謹慎操作。</p>',
  'group_domain_message' => '域名可使用最少 $domainlength 個 ，最多 30 個的字母或數字組合，且必須字母開頭。',
  'group_edit_domain_message' => '修改域名將需要支付積分<strong>{$consume}</strong>，你現在有擁有<strong>{$credits}</strong>',
  ...
  'my_thread' => '我的話題',
  'no_group_create_now' => '你還沒創建{$_G[setting][navs][3][navname]}，<a href="forum.php?mod=group&action=create">現在創建</a>',
  ...
  'group_exit_confirm' => '你確定要退出該{$_G[setting][navs][3][navname]}嗎？',
