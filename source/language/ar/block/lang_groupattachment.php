...
(
	...
	'groupattachment_fids_comment'		=> 'أدخل المنتديات المستدعاه, يمكنك إستخدام زر CTRL للتحديد بشكل معتعدد',//'指定群组，多个ID之间请用半角逗号“,”隔开。',
	'groupattachment_tids'			=> 'مواضيع محددة',//'指定主题',
	'groupattachment_tids_comment'		=> 'حدد أرقام المواضيع, إستخدم علامة الفاصلة للمتعدد',//'指定主题ID，多个ID之间用逗号分隔',
	...
	'groupattachment_dateline_week'			=> 'منذ أسبوع',//'最近1周',
