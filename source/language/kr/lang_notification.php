...
(
	...
	'type_wall'		=> '담벼락 메세지',//'留言',
	'type_piccomment'	=> '이미지 수',//'图片评论',
	'type_blogcomment'	=> '블로그 댓글',//'日志评论',
	'type_clickblog'	=> '블로그 위치',//'日志表态',
	'type_clickarticle'	=> '기사 위치',//'文章表态',
	'type_clickpic'		=> '이미지 위치',//'图片表态',
	'type_sharecomment'	=> '댓글 공유',//'分享评论',
	'type_doing'		=> '기록',//'记录',
	'type_friend'		=> '친구',//'好友',
	'type_credit'		=> '포인트',//'积分',
	'type_bbs'		=> '포럼',//'论坛',
