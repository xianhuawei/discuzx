...
$lang = array(
	...
	'app_invite_subject' => '{username} mời bạn tham gia {sitename} và cùng chơi {appname}',
	...
	'space_update' => '{actor} update thông tin',
	...
	'thread_edit_trail' => '<ins class="modify">[Chủ đề \\1 trong \\2 người sửa]</ins>',
	...
	'get_passwd_subject' => 'Check Email để lấy lại mật khẩu',
	'get_passwd_message' => 'Bạn có thời hạn 3 ngày để click vào liên kết sau để đặt lại mật khẩu: <br />\\1<br />(Nếu liên kết trên không hoạt động, hãy copy liên kết và dán vào khung địa chỉ của trình duyệt!)<br />Các trang ở trên sẽ mở ra, nhập mật khẩu mới rồi gửi, và bạn có thể sử dụng mật khẩu mới.',
	'file_is_too_big' => 'File quá lớn',

	'take_part_in_the_voting' => '{actor} tham gia {touser} Khảo sát {reward} <a href="{url}" target="_blank">{subject}</a>',
	...
	'apply_mtag_manager' => 'Sẵn lòng <a href="\\1" target="_blank">\\2</a> tùy chỉnh Nhóm vì lí do sau:\\3. <a href="\\1" target="_blank">(Click vào đây để quản lí)</a>',
	...
	'do_stat_appinvite' => 'Mời dùng apps',
	'do_stat_add' => 'Kết bạn',
	'do_stat_comment' => 'Bình luận',
	'do_stat_space' => 'Tương tác',
	'do_stat_doing' => 'Status',
	'do_stat_blog' => 'Blog',
	...
	'do_stat_docomment' => 'Bình luận status',
...
//vot	'do_stat_post' => 'Trả lời chủ đề',
	...
	'logs_credit_update_ECU' => 'Lấy lại chi UCenter',
