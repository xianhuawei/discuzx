...
(
	...
	'config_notfound'	=> 'Configuration file "config_global.php" does not exist or cannot access.',
	'template_notfound'	=> 'Template file does not exist or cannot access.',
	...
	'db_notfound_config'	=> 'onfiguration file "config_global.php" does not exist or cannot access.',
	...
	'system_init_ok'	=> 'Initialize site successfully, please <a href="index.php">click here</a> to enter',
	'backtrace'		=> 'Run information',
	'error_end_message'	=> '<a href="http://{host}">{host}</a> Details of this error message has been recorded.',
