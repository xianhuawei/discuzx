...
class table_forum_attachment_n extends discuz_table
{
	...
	/**
	 * 获取附件表名 forum_attachment_0 ～ 9 forum_attachment_unused(127)
	 * @param string $tableid 格式: “n” 附件分表编号；“aid:n”通过附件 id 获取表名；“tid:n”通过主题 id 获取表名；“pid:n”通过帖子 id 获取表名
	 * @return string 表名
	 */
	...
	/**
	 * 检查是否是所需的 id 字段
	 * @param string $idtype aid、tid、pid、uid
	 * @param type $ids id
	 * @return boolean
	 */
	...
	/**
	 * 删除指定附件表的数据
	 * @param string $tableid 格式“n/aid:n/tid:n/pid:n”
	 * @param int/array $val 附件 id
	 * @return boolean
	 */
	 ...
	 * 通过 id 删除指定附件表的数据
	 *@param string $tableid 格式“n/aid:n/tid:n/pid:n”
	 * @param string $idtype id 类型 aid、tid、pid、uid
	 ...
	 * 获取指定附件的数据
	 * @param string $tableid 格式“n/aid:n/tid:n/pid:n”
	 * @param int/array $aid 附件 id
	 * @param boolean $isimage 是否图片
	 * @return array
	 */
	 ...
	 * 获取指定附件表的多个数据
	 * @param string $tableid 格式“n/aid:n/tid:n/pid:n”
	 * @param int/array $aids 附件 id
	 * @param boolean $remote 是否远程附件
	 * @param boolean $isimage 是否图片附件
	 * @return array
	 */
	...
	/**
	 * 通过 pid和width 获取附件表中的数据
	 * @param string $tableid 格式“n/aid:n/tid:n/pid:n”
	 * @param int|array $pids 帖子id数组
	 * @param int $width 附件宽度
	 * @return array
	 */
