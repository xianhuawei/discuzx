...
//redis代理的配置
//$_config['memory']['redis']['proxy'][0]['server'] = '';
//$_config['memory']['redis']['proxy'][0]['port'] = 6379;
//$_config['memory']['redis']['proxy'][0]['pconnect'] = 1;
//$_config['memory']['redis']['proxy'][0]['timeout'] = '0';
//
//$_config['memory']['redis']['proxy'][1]['server'] = '';
//$_config['memory']['redis']['proxy'][1]['port'] = 6379;
//$_config['memory']['redis']['proxy'][1]['pconnect'] = 1;
//$_config['memory']['redis']['proxy'][1]['timeout'] = '0';
//
//$_config['memory']['redis']['proxy'][2]['server'] = '';
//$_config['memory']['redis']['proxy'][2]['port'] = 6379;
//$_config['memory']['redis']['proxy'][2]['pconnect'] = 1;
//$_config['memory']['redis']['proxy'][2]['timeout'] = '0';
